...
const defaultColors = ['#D4AF37', '#FF8C00', '#CC5500'];
...
`;
    ...
    class ShaderPass {
      ...
      constructor(props: unknown) {
        this.props = props || {};
        this.uniforms = (this.props as any).material?.uniforms;
      }
      init(..._args: unknown[]) {
        this.scene = new THREE.Scene();
        this.camera = new THREE.Camera();
        if (this.uniforms) {
          this.material = new THREE.RawShaderMaterial((this.props as any).material);
      ...
      update(..._args: unknown[]) {
        ...
        Common.renderer.setRenderTarget((this.props as any).output || null);
    ...
    class Viscous extends ShaderPass {
      ...
      update(...args: any[]) {
        ...
        for (let i = 0; i < iter; i++) {
          if (i % 2 === 0) {
            fbo_in = (this.props as any).output0;
            fbo_out = (this.props as any).output1;
          } else {
            fbo_in = (this.props as any).output1;
            fbo_out = (this.props as any).output0;
          }
          this.uniforms.velocity_new.value = fbo_in.texture;
          (this.props as any).output = fbo_out;
          if (typeof dt === 'number') this.uniforms.dt.value = dt;
          super.update();
        }
        return fbo_out;
    ...
    class Poisson extends ShaderPass {
      ...
      update(...args: any[]) {
        ...
        for (let i = 0; i < iter; i++) {
          if (i % 2 === 0) {
            p_in = (this.props as any).output0;
            p_out = (this.props as any).output1;
          } else {
            p_in = (this.props as any).output1;
            p_out = (this.props as any).output0;
          }
          if (this.uniforms) this.uniforms.pressure.value = p_in.texture;
          (this.props as any).output = p_out;
          super.update();
        }
        return p_out;
      }
